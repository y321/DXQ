...
public  class UsersTask extends AsyncTask<Users, Integer, String> {
    ...
    public UsersTask(SQLiteDatabase db){
        this.db=db;
    }
    ...
    protected String doInBackground(Users... users) {
        ...
        String retValue = userService.register(users[0]);
        Log.d("WeatherTask", retValue);
        return retValue;
    }
    ...
    protected void onPostExecute(String result) {
        Log.d("WeatherTask", "onPreExecute");
//        String ret = getResult(result);
//        this.mCallback.onFinished(ret);
    }
